...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Sistema de Inventario de mi chuzo");
        ...
        while(true){
            ...
            if (opcion == 6){
                System.out.println("Gracias por usar el sistema de inventario de mi chuzo");
                break;
            }
            ...
            switch (opcion) {
                case 1:
                    ...
                    if (!inventario.verificarStock(indiceProducto, cantidad)){
                        System.out.println("Mala mia, no hay stock");
                        continue;
                    }
